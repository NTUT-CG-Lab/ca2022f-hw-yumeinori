...
export class LAppDelegate {
   ...
   * @TODO runModel宣告
   */
   public runModel(x:number, y:number, scale: number): void {
    // メインループ
    const loop = (): void => {
      // インスタンスの有無の確認
      if (s_instance == null) {
      ...
      // 描画更新
      //@TODO call view renderModel
      this._view.renderModel(x, y, scale);
  ...
  private _resizeCanvas(): void {
    ...
    canvas.width = document.querySelector("#character").clientWidth;
    canvas.height = document.querySelector("#character").clientHeight;
  }
